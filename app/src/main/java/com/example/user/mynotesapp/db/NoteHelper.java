package com.example.user.mynotesapp.db;
...
import com.example.user.mynotesapp.entity.Note;

import java.util.ArrayList;

import static android.provider.BaseColumns._ID;
import static com.example.user.mynotesapp.db.DatabaseContract.NoteColumns.DATE;
import static com.example.user.mynotesapp.db.DatabaseContract.NoteColumns.DESCRIPTION;
import static com.example.user.mynotesapp.db.DatabaseContract.NoteColumns.TITLE;
import static com.example.user.mynotesapp.db.DatabaseContract.TABLE_NOTE;
