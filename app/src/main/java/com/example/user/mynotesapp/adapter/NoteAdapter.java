package com.example.user.mynotesapp.adapter;
...
import com.example.user.mynotesapp.CustomOnItemClickListener;
import com.example.user.mynotesapp.FormAddUpdateActivity;
import com.example.user.mynotesapp.R;
