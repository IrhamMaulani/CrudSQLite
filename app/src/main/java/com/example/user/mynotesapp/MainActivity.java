package com.example.user.mynotesapp;
...
import com.example.user.mynotesapp.adapter.NoteAdapter;
import com.example.user.mynotesapp.db.NoteHelper;
import com.example.user.mynotesapp.entity.Note;

import java.util.ArrayList;
import java.util.LinkedList;

import static com.example.user.mynotesapp.FormAddUpdateActivity.REQUEST_UPDATE;
